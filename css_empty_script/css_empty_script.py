...
class css_empty_script(ControlSurface):
	def __init__(self, c_instance):
		super(css_empty_script, self).__init__(c_instance)
	...
	def _mode1_volume_listener(self):
		self.show_message = "BD: Empty Script Example"
...
################################################
	...
	def set_active_mode(self, activate_new_mode):
		...
		if(activate_new_mode == "Previous Mode"):
			...
			mode_to_call()
	def disconnect(self):
		super(css_empty_script, self).disconnect()
